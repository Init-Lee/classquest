/**
 * 文件说明：模块 4 前端路由表。
 * 职责：在模块 4 独立 Shell 下分发首页、课时 1/2/3/4/5/6 子路由，后续提交页和画廊页也从这里扩展。
...
const Lesson6Routes = lazy(() => import("./lessons/lesson-6/routes"))
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        <Route path="lesson/6/*" element={<Lesson6Routes />} />
