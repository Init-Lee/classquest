...
import type { QualityCheckResult } from "@/modules/module-3-ai-science-station/domains/evidence/types"
  ...
  return (
    <div className="space-y-6 w-full max-w-7xl">
      ...
      <div className="flex items-center justify-between">
        <Button variant="outline" onClick={() => navigate("/module/3/lesson/2/step/3")}>
          <ArrowLeft className="h-4 w-4 mr-1" /> 上一步：修改证据
        </Button>
        <Button onClick={() => navigate("/module/3/lesson/2/step/5")} disabled={!allPassed}>
