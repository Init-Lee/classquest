...
import type { Lesson2Assignment } from "@/modules/module-3-ai-science-station/domains/evidence/types"
...
export default function Step1Combined() {
  ...
  const handleConfirm = async (confirmedName?: string) => {
    ...
    try {
      ...
      navigate("/module/3/lesson/2/step/2")
    } finally {
      setSaving(false)
    }
  }
      ...
      <div className="space-y-6 max-w-xl">
        ...
        <Card className="border-green-200 bg-green-50">
          ...
          <CardContent className="space-y-2">
            ...
            <Button className="w-full mt-3" onClick={() => navigate("/module/3/lesson/2/step/2")}>
