...
import type { Lesson3State } from "@/modules/module-3-ai-science-station/domains/portfolio/types"
  ...
  return (
    <div className="space-y-5 w-full max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
        <Button variant="outline" size="sm" onClick={() => navigate("/module/3/lesson/3/step/1")}>
