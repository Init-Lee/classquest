...
import type { GroupDiscussionEntry, GroupConsensus } from "@/modules/module-3-ai-science-station/domains/group-plan/types"
import { deserializeContinuePackage } from "@/modules/module-3-ai-science-station/infra/persistence/serializers/continue-package"
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-end">
        <Button
          onClick={() => navigate("/module/3/lesson/1/step/4")}
...
function LeaderView() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      navigate("/module/3/lesson/1/step/4")
    } finally {
      setSaving(false)
    }
  }
