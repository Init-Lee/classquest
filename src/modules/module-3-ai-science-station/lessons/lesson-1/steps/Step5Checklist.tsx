...
import type { GroupEvidencePlanRow } from "@/modules/module-3-ai-science-station/domains/group-plan/types"
...
export default function Step5Checklist() {
  ...
  const handleSaveAndNext = async () => {
    ...
    try {
      ...
      navigate("/module/3/lesson/1/step/5")
    } finally {
      setSaving(false)
    }
  }
    ...
    <div className={`flex gap-6 w-full transition-all duration-200 ${wideMain ? "max-w-7xl" : "max-w-2xl"}`}>
      ...
      <div className="flex-1 min-w-0 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Button
            variant="outline"
            onClick={() => subStep > 0 ? setSubStep(s => s - 1) : navigate("/module/3/lesson/1/step/3")}
          >
