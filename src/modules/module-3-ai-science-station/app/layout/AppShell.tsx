...
} from "@/modules/module-3-ai-science-station/app/teacher-demo-presets"
...
/** 从路径解析当前课时/关，如 `/module/3/lesson/4/step/1` */
function parseLessonStep(pathname: string): { lessonId: number; stepId: number } | null {
  const m = pathname.match(/^\/module\/3\/lesson\/(\d+)\/step\/(\d+)/)
  if (!m) return null
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 text-sm font-medium">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => { exitTeacherMode(); navigate("/module/3") }}
