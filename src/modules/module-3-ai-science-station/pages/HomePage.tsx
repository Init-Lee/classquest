...
import { createNewPortfolio } from "@/modules/module-3-ai-science-station/domains/portfolio/types"
...
export default function HomePage() {
  ...
  const handleCreated = () => {
    navigate("/module/3/lesson/1/step/1")
  }
        ...
        <div className="text-center space-y-3 py-8">
          ...
          <div className="flex items-center justify-center gap-3 pt-2 flex-wrap">
            ...
            <Button
              variant="outline"
              size="lg"
              onClick={() => navigate("/module/3/legacy-import")}
            >
    ...
    <div className="space-y-8">
      ...
      <Card className="max-w-lg mx-auto border-primary/20 bg-primary/5">
        ...
        <CardContent className="space-y-3">
          ...
          <Button
            className="w-full"
            onClick={() => navigate(`/module/3/lesson/${portfolio!.pointer.lessonId}/step/${portfolio!.pointer.stepId}`)}
          >
            继续闯关
            <ArrowRight className="h-4 w-4 ml-1" />
          </Button>
                ...
                {lesson.enabled && (
                  <CardContent className="pt-0">
                    <Button
                      ...
                      size="sm"
                      className="w-full"
                      onClick={() => navigate(`/module/3/lesson/${lesson.id}/step/1`)}
                    >
                      {isTeacherMode
                        ? "浏览本课"
                        : isCurrent
