...
import type { SkeletonPackageV1 } from "@/infra/persistence/serializers/continue-package"
          ...
          <Card className="overflow-hidden">
            ...
            <div className="border-t px-3 py-2.5 bg-gray-50 flex items-center gap-2 flex-wrap">
              ...
              {lesson4.personalDraftCompleted ? (
                <Button size="sm" onClick={() => navigate("/lesson/4/step/3")} className="gap-1.5">
