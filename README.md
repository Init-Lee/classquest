...
> 课时 3-4 跨课时数据流：课时3第5关导出 JSON「个人整理包」→ 课时4第1关组长导入所有成员包、合并并导出「小组骨架包 v1」→ 组员导入骨架包 → 各自完成个人草稿 → 组长记录制作方案并导出供组员导入 → 协商生成网页 v1 → 升级校验并导出最终版 HTML。**结构说明见 [FILE-STRUCTURE.md](FILE-STRUCTURE.md) 中「课时3 · 结构摘要」与「课时4 · 结构摘要」**。
...
| Phase 8: UI/UX 视觉优化（色彩系统、排版、响应式） | 📋 规划中 |
