...
- 当前主线版本：`0.7.2`，模块 4 课时 2「素材搜集与合规初筛」本地前端流程已合入后的发布口径。
- 当前开发分支：`module-4-lesson-2-dev`，用于完成并发布模块 4 课时 2；后续课时继续按独立分支推进。
- 模块 4 当前已建立独立 app / domains / infra / lessons 结构，课时 1-2 已落地；课时 3-6 后续逐课时开发。
